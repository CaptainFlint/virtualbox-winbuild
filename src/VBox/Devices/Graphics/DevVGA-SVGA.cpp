...
# endif
    ...
    STAM_REL_REG(pVM, &pSVGAState->StatR3Cmd3dBlitSurfaceToScreenProf, STAMTYPE_PROFILE, "/Devices/VMSVGA/Cmd/3dBlitSurfaceToScreenProf", STAMUNIT_TICKS_PER_CALL, "Profiling of SVGA_3D_CMD_BLIT_SURFACE_TO_SCREEN.");
